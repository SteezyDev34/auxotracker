...
class LeagueLogoService
{
     ...
     */
    public function ensureLeagueLogos(League $league, bool $force = false): ?array
    {
        ...
        $lightExists = Storage::disk('public')->exists($lightLogoPath);
        $darkExists = Storage::disk('public')->exists($darkLogoPath);
        ...
        // Si au moins un logo existe et qu'on ne force pas, mettre à jour le champ img et retourner les logos existants
        if (!empty($existingLogos) && !$force) {
