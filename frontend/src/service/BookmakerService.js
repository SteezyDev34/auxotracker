...
export const BookmakerService = {
  ...
  async getUserBookmakers() {
    try {
      ...
      console.error(
        "Erreur lors de la récupération des bookmakers utilisateur:",
        error
      );
      throw error;
    }
  ...
  async createUserBookmaker(bookmakerData) {
    try {
      ...
      console.error(
        "Erreur lors de la création du bookmaker utilisateur:",
        error
      );
      throw error;
    }
  ...
  async updateUserBookmaker(bookmarkerId, bookmakerData) {
    try {
      const response = await fetch(
        `${API_BASE_URL}/user-bookmakers/${bookmarkerId}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
      ...
      console.error(
        "Erreur lors de la mise à jour du bookmaker utilisateur:",
        error
      );
      throw error;
    }
  ...
  async deleteUserBookmaker(bookmarkerId) {
    try {
      ...
      console.error(
        "Erreur lors de la suppression du bookmaker utilisateur:",
        error
      );
      throw error;
    }
