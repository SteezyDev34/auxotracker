...
// Variables pour le champ mise avec sélecteur de type
    ...
    <Fluid class="flex flex-col md:flex-row gap-8">
        <div class="md:w-1/2">
            <div class="card flex flex-col gap-4">
                ...
                <div class="font-semibold text-xl">Champ Mise avec Sélecteur</div>
                <div class="flex gap-2 items-end">
                    <div class="flex-1">
                        <label class="block text-sm font-medium mb-2">Montant de la mise</label>
                        <InputNumber 
                            v-model="betAmount" 
