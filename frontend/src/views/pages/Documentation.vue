<template>
  <div class="card">
    ...
    <p class="text-lg mb-4">
      AUXOBOT is an application template for Vue based on the
      <a
      ...
      <a
        href="https://github.com/SteezyDev34/auxotracker"
        class="font-medium text-primary hover:underline"
        >repository</a
      >
    ...
    <pre class="app-code">
<code>git clone https://github.com/SteezyDev34/auxotracker
npm install
npm run dev</code></pre>
    ...
    <div class="font-semibold text-xl mb-4">
      Add AUXOBOT-Vue to a Nuxt Project
    </div>
    <p class="text-lg mb-4">To get started, create a Nuxt project.</p>
    <pre class="app-code">
<code>npx nuxi@latest init auxobot-nuxt</code></pre>
