...
const register = async () => {
  ...
  try {
    // Requête d'inscription avec authentification par token uniquement
    const response = await axios.post(
      "https://api.auxotracker.lan/api/register",
      {
        ...
        >
          <div class="text-center mb-8">
            ...
            <span class="text-muted-color font-medium"
              >Inscrivez-vous pour continuer</span
            >
          </div>
          ...
          <div>
            ...
            <pre
              v-if="errorDetails"
              class="text-gray-500 bg-gray-100 p-2 rounded text-xs mt-2 overflow-auto"
              >{{ errorDetails }}</pre
            >
