      ...
      <div class="flex justify-between items-start mb-4">
        <div>
          ...
          <p class="text-surface-600 dark:text-surface-400">
            Sélectionnez vos sports d'intérêt et triez-les par ordre de
            préférence
          </p>
        </div>
        <Button
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <Card class="h-fit">
        ...
        <template #content>
          ...
          <div
            v-else-if="availableSports.length === 0"
          ...
          <div v-else class="space-y-3">
            ...
            >
              ...
              <div
                v-else
                class="w-8 h-8 bg-surface-200 dark:bg-surface-700 rounded-lg flex items-center justify-center"
              >
      ...
      <Card class="h-fit">
        ...
        <template #content>
          <div v-if="favoriteSports.length === 0" class="text-center py-8">
            <i
              class="pi pi-star-fill text-4xl text-surface-300 dark:text-surface-600 mb-3"
            ></i>
          ...
          <div v-else>
            ...
            <div ref="favoriteSportsContainer" class="space-y-3">
              ...
              >
                <div
                  class="flex items-center justify-center w-6 h-6 bg-primary-500 text-white rounded-full text-sm font-bold"
                >
                  {{ index + 1 }}
                </div>
