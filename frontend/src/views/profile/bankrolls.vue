<template>
  ...
  <Fluid>
    <div class="flex flex-col gap-8">
      ...
      >
        <div>
          ...
          <p class="text-gray-600 dark:text-gray-300 mt-2">
            Gérez vos bankrolls et suivez vos performances
          </p>
        </div>
        <Button
      ...
      <div
        class="bg-surface-0 dark:bg-surface-900 border border-surface-200 dark:border-surface-700 rounded-lg"
      >
        <div class="p-6">
          <BankrollCard
            :bankrolls="bankrolls"
  ...
  >
    <div class="flex flex-col gap-4">
      ...
      <div>
        ...
        <Textarea
          v-model="newBankroll.description"
          placeholder="Description de votre bankroll"
          class="w-full"
          rows="3"
        />
      </div>
      <div>
        <label class="block text-sm font-medium mb-2"
          >Montant de départ *</label
        >
        <InputNumber
          v-model="newBankroll.startAmount"
          mode="currency"
          currency="EUR"
          locale="fr-FR"
          class="w-full"
    ...
    <template #footer>
      <div class="flex justify-end gap-2">
        ...
        />
        <Button
          :label="editingBankroll ? 'Modifier' : 'Créer'"
          @click="saveBankroll"
          :loading="saving"
        />
      </div>
...
const confirmDeleteBankroll = async () => {
  ...
  // Vérifier que le nom saisi correspond
  ...
  try {
    ...
    toast.add({
      severity: "error",
      summary: "Erreur",
      detail: err.message || "Impossible de supprimer la bankroll",
      life: 3000,
    });
  } finally {
